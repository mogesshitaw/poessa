         ...
         <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
              <h1 class="mb-2 bread"><span><?php echo $pagename; ?> Resource</span></h1>
   ...
   <div class="container ">  
    ...
    <div class="row">
          ...
          if(isset($_POST['search'])){
            ...
            $sql2="SELECT * from media where M_type like 'application%' and M_title like '%$title%'";
            }
           elseif($pagename !='whole' && $pagename !='All Document' && $pagename !=''){
            $sql2="SELECT * from media where M_type like 'application%' and category='$pagename'";}
            elseif($pagename =='whole'){
              $sql2="SELECT * from media";
            }
            else{
               $sql2="SELECT * from media where M_type like 'application%'" ;
            }
        ...
        <div class="blog-entry">
          <div class="card">
            <div class="card-body">
              ...
              <h6><strong><i class="fa fa-database"></i>  </strong><?php echo $row1['M_size']; ?></h6>
              <h6><strong><i class="fa fa-calendar"></i> </strong><?php echo $row1['date']; ?></h6>
              <h6><strong><i class="fa fa-list-alt"></i> </strong><?php echo $row1['category']; ?></h6>
              <a href="resource/<?php echo $row1['M_fullname']; ?>"  class="btn btn-primary">View now</a>
    ...
    <div class="col-md-4 mt-0 ftco-animate">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    <form  action="document.php?pagename=searched for" method="post">
                ...
                <h5 class="card-header">Recent document</h5>
                  <div class="card-body">
                   <ul class="mb-0">
                    <?php
                    $cnt=0;
                    $query=mysqli_query($conn,"SELECT * from media where  M_type like 'application%'  ORDER BY M_id DESC ");
